    ...
    <footer className="bg-white dark:bg-dark_bg text-surface/75 dark:text-white/75">
      <div className="container mx-auto py-4 px-6">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4 text-center md:text-left">
          <div>
            <h6 className="font-semibold uppercase mb-4 text-neutral-800 dark:text-white">
              Company Name
            </h6>
            <p className="text-neutral-600 dark:text-white/75">
              Organize your footer content effectively. Lorem ipsum dolor sit
            ...
            <ul className="space-y-2">
              {techStackItems.map((item, index) => (
                <li key={index}>
                  <a
                    href={item.href}
                    className="block text-neutral-600 dark:text-white/75 hover:text-secondary transition-transform duration-300 ease-in-out transform translate-y-0 hover:translate-y-[-4px]"
                  >
                    {item.text}
                  </a>
                </li>
      ...
      <div className="bg-neutral-200 dark:bg-dark_bg py-4 text-center">
        ...
        <a
          ...
          className="font-semibold text-neutral-800 dark:text-white ml-1"
        ></a>
      </div>
    </footer>
  );
